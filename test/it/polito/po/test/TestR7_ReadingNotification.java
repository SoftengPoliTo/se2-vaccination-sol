...
import static it.polito.po.test.TestUtils.*;
...
public class TestR7_ReadingNotification {
	...
	public void setUp() throws VaccineException {
		...
		lines.addAll(generatePersons(NUM_PERSONS));
	...
	@Test
	public void testWrongHeader1() throws IOException {
		...
		assertEquals("Missing notification for wrong header", 1, errors.size());
	}

	@Test
	public void testWrongHeader2() throws IOException {
	...
	public void testIncomplete() throws IOException, VaccineException {
		...
		v.loadPeople(r);
		assertEquals("Missing notification for incomplete line", 1, v.countPeople());
	}
}
